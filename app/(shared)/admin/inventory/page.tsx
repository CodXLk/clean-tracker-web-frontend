...
export default function InventoryPage() {
  ...
  // top of it; the desktop sidebar/full-nav is unaffected since it never overlaps these panels.
  ...
  return (
    <>
      ...
      {/* Mobile — cleaner request-list layout */}
      <div
      ...
      >
        ...
        <main className="mx-auto max-w-2xl px-5 pb-28 -mt-5">
          <div className="flex flex-col gap-4 pt-5">
            <FilterTabs options={[...STATUS_TABS]} value={activeFilter} onChange={setActiveFilter} />
            ...
            <div>
              ...
              {isLoading ? (
                ...
                <p className="py-12 text-center text-sm text-grey-500">
                  No requests yet. Tap &ldquo;Request Items&rdquo; to raise one.
                </p>
              ) : (
